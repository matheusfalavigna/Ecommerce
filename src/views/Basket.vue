          ...
          <div v-for="(product, index) in productsInBag" :key="index" class="item">
            ...
            <div class="price">
              <span class="quantity-area">
                <!-- botao de diminuir a quantidade de produtos 
                quando chega em 1, ele desabilita o botao -->
                <button :disabled="product.quantity<=1" @click="product.quantity--">-</button>

                <span class="quantity">{{product.quantity}}</span>
                <!-- botao de aumentar a quantidade de produtos -->
                <button @click="product.quantity++">+</button>

              </span>
              <!-- aqui ja mostra o valor do produto mutiplicado pelo a quantidade -->
  ...
  <script>
  // essa lib facilita para simplificar o codigo
